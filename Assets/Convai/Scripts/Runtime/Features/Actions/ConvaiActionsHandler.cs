    ...
    public class ConvaiActionsHandler : MonoBehaviour
    {
        ...
        private void Reset()
        {
            actionMethods = new ActionMethod[]
            {
                ...
                new() { action = "Pop Up", actionChoice = ActionChoice.PopUp },
                new() { action = "Name", actionChoice = ActionChoice.Name },
        ...
        //Overwritten methods utilised with Narrative Design to intiate actions without user input
        public void UpdateND(string location)
        {   
            ParseActions("Move To " + location);
        }
         public void UpdateNDSIT(string location)
        {
            //ParseActions("Move To " + location);
            Sit();
        ...
        //New sit action, calling the animation
        private void Sit()
        {
            //popUpText.text = "MOVING";
            Animator animation; 
            animation = _currentNPC.GetComponent<Animator>();
            animation.SetBool("Sitting", true);
        }
